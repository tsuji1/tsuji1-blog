/* eslint-disable */
// Generated by Wrangler by running `wrangler types --path=./functions/types.d.ts` (hash: d2e3f16c5c0f9cad1b0209a3ff4a0a9d)
// Runtime types generated with workerd@1.20250803.0 2025-08-12 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		BLOG_POSTS_KV: KVNamespace;
		"0": {"JWT_ISSUER":"tsuji1-blog-preview"};
		API: string;
		JWT_ISSUER: string;
		JWT_SECRET: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "0" | "API" | "JWT_ISSUER" | "JWT_SECRET">> {}
}
